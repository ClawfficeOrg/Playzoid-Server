...
function mapType(zExpr) {
  ...
  if (zExpr.startsWith("z.any") || zExpr.startsWith("z.unknown"))
...
function generateStruct(name, fields) {
  ...
  lines.push(`pub struct ${toPascalCase(name)} {`);
...
// Convert an arbitrary identifier (potentially containing hyphens, dots, or
// snake_case segments) into a valid Rust PascalCase struct name.
// Examples:
//   put-storage_Body  -> PutStorageBody
